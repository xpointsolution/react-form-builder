...
const {
  ...
  DatePicker, RadioButtons, Image, Rating, Tags, Signature, HyperLink, Download, Camera, Range, FileUpload, Recaptcha,
} = BaseFormElements;
...
FormElements.Recaptcha = SortableElement(Recaptcha);
